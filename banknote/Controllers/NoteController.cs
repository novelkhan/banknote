...
namespace banknote.Controllers
{
    public class NoteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NoteId,NoteName,NoteValue,Id")] Note note)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NoteId,NoteName,NoteValue,Id")] Note note)
        {
            if (id != note.Id)
            {
                return NotFound();
